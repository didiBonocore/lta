...
|-------|---------|---------|
| 0 | `analyse:acquire owner/repo` | Full `git clone` into `storage/corpus/` (never `--depth 1`); records HEAD sha, clone date, licence and GitHub creation date. The corpus is read-only after this. |
